...
export const PERMISSIONS = {
  ...
  JOURNAL_EDIT: {
    module: 'journal',
    action: 'edit',
    description: 'Edit journal entries',
  },
  JOURNAL_DELETE: {
    module: 'journal',
    action: 'delete',
...
export function getRolePermissions(role: Role): Permission[] {
  return ROLE_PERMISSIONS[role].map(
...
export function canAssignRole(assignerRole: Role, targetRole: Role): boolean {
  ...
  if (assignerRole === 'manager')
    return ['assistant', 'accountant'].includes(targetRole);
...
export const GLOBAL_PERMISSIONS = {
  ...
  SYSTEM_VIEW_ALL_COMPANIES: {
    ...
    description: 'View all companies in system',
  },
  ...
  SYSTEM_MANAGE_GLOBAL_USERS: {
    module: 'system',
    action: 'manage_global_users',
    description: 'Manage global user roles',
  },
  ...
  SYSTEM_ACCESS_ALL_DATA: {
    module: 'system',
    action: 'access_all_data',
    description: 'Access data across all companies',
  },
} as const;
...
export const GLOBAL_ROLE_PERMISSIONS: Record<
  GlobalRole,
  (keyof typeof GLOBAL_PERMISSIONS)[]
> = {
...
export function hasGlobalPermission(
  ...
  permission: keyof typeof GLOBAL_PERMISSIONS,
): boolean {
