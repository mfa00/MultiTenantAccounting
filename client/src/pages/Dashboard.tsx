          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="metric-change neutral">Across 3 accounts</p>
              </div>
            ...
            <div className="h-64 bg-muted rounded-lg flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Revenue chart will be implemented
                </p>
              </div>
            </div>
          </CardContent>
                ...
                {recentTransactions && recentTransactions.length > 0 ? (
                  recentTransactions.map((transaction) => (
                    <TableRow key={transaction.id}>
                      ...
                      <TableCell>
                        <Badge
                          className={`status-badge ${transaction.isPosted ? 'income' : 'expense'}`}
                        >
                  ...
                  <TableRow>
                    ...
                    >
                      No transactions found. Create your first journal entry to
                      get started.
                    </TableCell>
                  </TableRow>
                )}
